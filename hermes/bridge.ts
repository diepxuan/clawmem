...
export function createHermesClawMemTools(
  cfg: ClawMemConfig,
  logger?: Logger,
): HermesClawMemToolDef[] {
  return [
...
function createHermesSearch(
  ...
  return {
    name: "clawmem_search",
    description:
      "Search long-term memory via ClawMem REST API. Supports keyword, semantic, and hybrid modes. " +
...
function createHermesStore(
  ...
  return {
    name: "clawmem_store",
    description:
      "Save a new memory entry via ClawMem REST API. Use for storing important facts, decisions, " +
...
function createHermesSessionLog(
  cfg: ClawMemConfig,
  _logger?: Logger,
): HermesClawMemToolDef {
  return {
    ...
    description:
      "List recent session summaries from ClawMem. Use when asked about past work, " +
...
function createHermesSimilar(
  ...
  return {
    ...
    description:
      "Find documents semantically similar to a given document via ClawMem graph API. " +
